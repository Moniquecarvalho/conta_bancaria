...
public class Menu {
	...
	private static void criarContasTeste() {
		...
		contaController
				.cadastrar(new ContaCorrente(contaController.gerarNumero(), 456, 1, "Maria Silva", 2000.00f, 200.00f));
		contaController
				.cadastrar(new ContaPoupanca(contaController.gerarNumero(), 123, 1, "Juliana Lima", 1000.00f, 12));
		contaController
				.cadastrar(new ContaPoupanca(contaController.gerarNumero(), 123, 2, "Fernanda Gomes", 8000.00f, 23));
	}
	...
	private static void atualizarConta() {
		...
		if (conta != null) {
			...
			System.out.printf("Agência atual: %dNova Agência (pressione ENTER para manter): ", agencia);
			String entrada = leia.nextLine();
			agencia = entrada.isEmpty() ? agencia : Integer.parseInt(entrada);

			System.out.printf("Titular atual: %dNovo Titular (pressione ENTER para manter): ", titular);
