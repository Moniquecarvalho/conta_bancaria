...
1. Clone o repositório [Aulas Java](https://github.com/Moniquecarvalho/conta_bancaria.git) dentro da pasta do *Workspace* do Eclipse/STS

```bash
git clone https://github.com/Moniquecarvalho/conta_bancaria.git
```
...
Desenvolvido por [**Monique Carvalho**](https://github.com/Moniquecarvalho)
